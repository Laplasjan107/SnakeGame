...
This project implements popular game - The Snake, using Text User Interface.

In order to turn on the game go to the SnakeGame directory  write in your Commandline:
    mkdir release
    cd release
    cmake ..
    make
